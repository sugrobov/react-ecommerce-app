...
export const mockProducts = [
    ...
    },
    {
        ...
        category_id: 4,
        description: "Прочный горный велосипед"
    },
    {
        id: 20,
        name: "Микроволновая печь",
        category_id: 5,
        description: "Компактная микроволновка"
    },
    {
        id: 21,
...
export const mockProductImages = [
    // iPhone - несколько изображений
    { id: 1, product_id: 1, image_url: generateProductImage("iPhone Front") },
    { id: 2, product_id: 1, image_url: generateProductImage("iPhone Back") },
    { id: 3, product_id: 1, image_url: generateProductImage("iPhone Side") },

    // MacBook - несколько изображений
    { id: 4, product_id: 2, image_url: generateProductImage("MacBook Open") },
    { id: 5, product_id: 2, image_url: generateProductImage("MacBook Closed") },

    // Остальные товары - по одному изображению
    { id: 6, product_id: 3, image_url: generateProductImage("Футболка") },
    { id: 7, product_id: 4, image_url: generateProductImage("Джинсы") },
    { id: 8, product_id: 5, image_url: generateProductImage("JS Book") },
    { id: 9, product_id: 6, image_url: generateProductImage("React Book") },
    { id: 10, product_id: 7, image_url: generateProductImage("Беговая дорожка") },
    { id: 11, product_id: 8, image_url: generateProductImage("Гантели") },
    { id: 12, product_id: 9, image_url: generateProductImage("Кофемашина") },
    { id: 13, product_id: 10, image_url: generateProductImage("Пылесос") },
    { id: 14, product_id: 11, image_url: generateProductImage("Test 1") },
    { id: 15, product_id: 12, image_url: generateProductImage("Test 2") },
    { id: 16, product_id: 13, image_url: generateProductImage("Test 3") },
    { id: 17, product_id: 14, image_url: generateProductImage("Test 4") },
    { id: 18, product_id: 15, image_url: generateProductImage("Samsung Phone") },
    { id: 19, product_id: 16, image_url: generateProductImage("iPad") },
    { id: 20, product_id: 17, image_url: generateProductImage("Куртка") },
    { id: 21, product_id: 18, image_url: generateProductImage("Python Book") },
    { id: 22, product_id: 19, image_url: generateProductImage("Велосипед") },
    { id: 23, product_id: 20, image_url: generateProductImage("Микроволновка") },
    { id: 24, product_id: 21, image_url: generateProductImage("Длинный товар 1") },
    { id: 25, product_id: 22, image_url: generateProductImage("Длинный товар 2") }
];
...
export const mockProductVariations = [
    ...
    { id: 15, product_id: 15, price: 59990, stock: 7 },
    { id: 16, product_id: 16, price: 79990, stock: 4 },
    { id: 17, product_id: 17, price: 8990, stock: 15 },
    { id: 18, product_id: 18, price: 1490, stock: 22 },
    { id: 19, product_id: 19, price: 15990, stock: 8 },
    { id: 20, product_id: 20, price: 8990, stock: 11 },
    { id: 21, product_id: 21, price: 29990, stock: 3 },
    { id: 22, product_id: 22, price: 129990, stock: 2 }
];